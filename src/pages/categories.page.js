...
class Categories {
	constructor(page, mobile) {
		...
		this.paginationList = page.locator("//div[@class='card-footer py-4']//ul[1]/li");
	}
	...
	async goToLastPage() {
		await this.page.locator(`li:left-of(a:has-text("Next"))`).locator('nth=0').click();
	}
}
...
class AddCategory {
	constructor(page, mobile) {
		...
		this.parentName = locator("//span[text()='Es subcategoria?']/following::input");
